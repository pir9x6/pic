...
extern void _set_tls(void *);       /* set current tls */
extern void _init_tls(void *);      /* initialise tls */
extern size_t _tls_size(void);      /* size of the TLS section */
extern size_t _tls_align(void);     /* alignment requirements for tls section */
